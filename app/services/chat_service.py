...
from app.utils.tools import (set_db_session, schedule_interview, check_interview, volunteer_interview, show_volunteers,
...
class ChatService():
    def __init__(self, db: AsyncSession):
        set_db_session(db)
        self.tools = [schedule_interview, check_interview, volunteer_interview, show_volunteers, 
                      finalize_volunteers, end_interview]
